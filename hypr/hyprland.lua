...
hl.on("hyprland.start", function () 
  ...
  hl.exec_cmd("hypctl setcursor Adwaita 17")
...
--  hl.exec_cmd("bash -c 'sleep 2 && VBoxClient --clipboard'")
end)
...
hl.bind(main_mod .. " + ESCAPE", function()
    hl.exec_cmd("bash ~/.config/rofi/scripts/powermenu.sh")
end)
...
hl.bind(main_mod .. " + V", function()
    hl.exec_cmd("cliphist list | rofi -dmenu -display-columns 2 | cliphist decode | wl-copy")
end)
hl.bind(main_mod .. " + SHIFT + V", function()
    hl.exec_cmd("bash ~/.config/hypr/clip-toggle.sh")
end)
...
hl.bind("Print", function()
    hl.exec_cmd("grim -g \"$(slurp)\" - | wl-copy && notify-send 'Screenshot' 'Area copied to clipboard'")
end)

-- Screenshot full screen to clipboard (using Shift + PrintScreen)
hl.bind("SHIFT + Print", function()
    hl.exec_cmd("grim - | wl-copy && notify-send 'Screenshot' 'Full screen copied to clipboard'")
end)
